														...
														<div class="row">
															<div class="col-xs-12 col-md-12 col-lg-4">
																<div class="form-group">
																	...
																	<input type="date" class="form-control" id="fecha_atencion" name="fecha_atencion" min="2023-01-01" max="2024-12-31">
																</div>
															</div>
															<div class="col-xs-12 col-md-12 col-lg-4">
																<div class="form-group">
																	<label for="fum">Fecha ultima de mestruación</label>
																	<input type="date" class="form-control" id="fum" name="fum" min="2022-04-01" max="2024-12-31" onChange="obtenerFPP();">
																</div>
															</div>
															<div class="col-xs-12 col-md-12 col-lg-4">
																<div class="form-group">
