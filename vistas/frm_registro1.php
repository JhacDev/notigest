														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-12 col-lg-4">
																...
																<div class="form-group">
																	...
																	<input type="date" class="form-control" id="fecha_atencion" name="fecha_atencion" min="2023-01-01" max="2023-12-31">
															...
															<div class="col-xs-12 col-md-12 col-lg-4">
																...
																<div class="form-group">
																	...
																	<input type="date" class="form-control" id="fum" name="fum" min="2022-04-01" max="2023-12-31" onChange="obtenerFPP();">
														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-12 col-lg-4">
																...
																<div class="form-group">
																	...
																	<label for="hb_ajustado">Hb ajustada</label>

																	<input type="text" class="form-control" id="hb_ajustado" name="hb_ajustado" placeholder="Hemoglobina" maxlength="5" style="text-transform: uppercase;" onkeypress="return soloDecimales(event);">
