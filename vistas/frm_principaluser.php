			...
			<section class="content">
				...
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						...
						<li class="breadcrumb-item active">TABLERO INFORMATIVO RED - <?php echo $_SESSION["red"]; ?></li>
						...
						<div class="col-xl-4">
							...
							<div class="card mb-4">
								...
								<div class="card-header">
									...
									TOTAL DE GESTANTES RED-<?php echo $_SESSION["red"]; ?>- SEGUN MICRORED AÑO ACTUAL
						...
						<div class="col-xl-4">
							...
							<div class="card mb-4">
								...
								<div class="card-header">
									...
									TOTAL GESTANTES RED-<?php echo $_SESSION["red"]; ?>- SEGUN MICRORED POR MES
						...
						<div class="col-xl-4">
							...
							<div class="card mb-4">
								...
								<div class="card-header">
									...
									TOTAL LUGAR DE PARTO RED-<?php echo $_SESSION["red"]; ?>- SEGUN MICRORED
					...
					<ol class="breadcrumb mb-4">
						...
						<li class="breadcrumb-item active">REPORTE CUANTITATIVO RED - <?php echo $_SESSION["red"]; ?></li>
