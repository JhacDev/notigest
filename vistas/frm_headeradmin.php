				...
				<nav class="mt-2">
					...
					<ul class="nav nav-pills nav-sidebar nav-compact nav-child-indent flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							...
							<a href="frm_rptnotigest.php" class="nav-link">
						...
						<li class="nav-header"><h6>CONFIGURACIÓN</h6></li>

						<!-- <li class="nav-item">
								<a href="frm_principaladmin.php" class="nav-link">

								<div class="d-flex align-items-center">
								<div class="image">
									<img src="../public/imagenes/interfaz-de-usuario.png" class="img-circle elevation-2" alt="User Image" style="max-width: 34px; height: auto;">
								</div>
								<p class="mb-0 ms-2"> 
								    Reporte de Usuario
								</p>
						...
						<li class="nav-item">
						<a href="frm_usuario.php" class="nav-link">
						...
						<li class="nav-header"><h6>CERRAR SESIÓN</h6></li>
