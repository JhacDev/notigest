...
?>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid px-4">
					<h1 class="mt-4">DASHBOARD RED - <?php echo $_SESSION["red"]; ?></h1>
					<ol class="breadcrumb mb-4 ">
						<li class="breadcrumb-item active">TABLERO INFORMATIVO POR RED DE SALUD - <?php echo $_SESSION["red"]; ?></li>
					</ol>
					...
					<div class="row">
						<div class="col-xl-4">
							<div class="card mb-4">
								<div class="card-header">
									...
									TOTAL DE GESTANTES POR RED- <?php echo $_SESSION["red"]; ?> - SEGUN MICRORED AÑO ACTUAL 
								</div>
						...
						<div class="col-xl-4">
							<div class="card mb-4">
								<div class="card-header">
									...
									TOTAL GESTANTES POR MES RED -  <?php echo $_SESSION["red"]; ?>
								</div>
						...
						<div class="col-xl-4">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i>
									TOTAL LUGAR DE PARTO RED -  <?php echo $_SESSION["red"]; ?>
								</div>
					...
					<div class="row">
						...
						<div class="col-xl-2 col-md-6">
							<div class="card bg-danger text-white mb-4 text-center">
								...
								<div class="ms-3 fs-3" id="totalProbableParto"></div>
								<div class="card-footer d-flex align-items-center justify-content-between">
									<!-- <a class="small text-white stretched-link" href="#">View Details</a> -->
									<!-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> -->
								</div>
						...
						<div class="col-xl-2 col-md-6">
							<div class="card bg-danger text-white mb-4 text-center">
								...
								<div class="ms-3 fs-3" id="totalAbortoRed"></div>
								<div class="card-footer d-flex align-items-center justify-content-between">
									<!-- <a class="small text-white stretched-link" href="#">View Details</a> -->
									<!-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> -->
								</div>
					...
					<div class="card mb-4">
						<div class="card-header">
							...
							REPORTE NOMINAL GESTANTE CON FECHA PROBABLE DE PARTO EN EL MES ACTUAL RED - <?php echo $_SESSION ['red'] ?>
						</div>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
		...
		<script type="text/javascript" src="scripts/panelRedes.js"></script>
<?php
}
ob_end_flush();
?>